...
> `src/domain` and `src/lib`, which import nothing from the database or the UI — 235 unit
> tests run in under a second with no infrastructure. 42 Playwright specs build their own
