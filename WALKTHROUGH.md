...
> `src/domain` and `src/lib`, which import nothing from the database or the UI — 228 unit
> tests run in under a second with no infrastructure. 40 Playwright specs build their own
